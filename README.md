# LLLM Playground
## Description
This repository contains a personal UI and a set of tools I created to easily try out local LLMs. For the inference part of the LLM I use `llama.cpp` and for the UI I use `streamlit`.  
